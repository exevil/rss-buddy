...
class MockAIInterface(AIInterface):
    ...
    def generate_consolidated_summary(
        ...
        for article in articles:
            summary += f"<li><a href='{article['link']}'>{article['title']}</a>: {article['summary'][:50]}...</li>"
        summary += "</ul>"
